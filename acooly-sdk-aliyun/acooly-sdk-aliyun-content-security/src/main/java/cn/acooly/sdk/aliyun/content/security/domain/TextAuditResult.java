 ...
 */
package cn.acooly.sdk.aliyun.content.security.domain;
...
public class TextAuditResult extends DtoBase {
	...
	/**
	 * 建议您执行的后续操作。取值 pass：文本正常，可以直接放行。 review：文本需要进一步人工审核。 block：文本违规，可以直接删除或者限制公开。
	 */
	private String suggestion;

	/**
	 * 文本垃圾检测结果的分类。取值： normal：正常文本 spam：含垃圾信息 ad：广告 politics：涉政 terrorism：暴恐
